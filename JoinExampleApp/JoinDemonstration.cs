...
namespace JoinExampleApp
{
    public class JoinDemonstration
    {
        ...
        public void GroupJoin()
        {
            ...
            {
                Console.WriteLine("Group:"+prodGrouping.Select(c=>c.Name).FirstOrDefault());
        ...
        public void GroupInnerJoin()
        {
            ...
            {
                Console.WriteLine(productGroup.Category+":"+productGroup.Products.Count());
                foreach (var prodItem in productGroup.Products)
                {
                    totalItems++;
                    Console.WriteLine("  {0,-10} {1}", prodItem.Name, productGroup.Category);
                }
            }
